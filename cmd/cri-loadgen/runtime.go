...
var (
	criSocket = flag.String("cri-socket", "", "cri-o socket to use")
...
func ConnectRuntime() (*runtime, error) {
	...
	cc, err := grpc.DialContext(ctx, *criSocket, dialOpts...)
	if err != nil {
...
func (r *runtime) PullImages() error {
	...
	for name, setRef := range map[string]func(string){
		...
		pauseImage: func(ref string) { imgRefs.pause = ref },
	} {
...
func WithoutCommand() ContainerOption {
	return func(cfg *cri.ContainerConfig) error {
		cfg.Command = nil
		return nil
	}
